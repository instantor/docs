  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">This method is used for loading the frame with a bank preselected, omitting
        ...
        bankID fails silently and the bank-chooser component is displayed as fallback. <em>NOTE: WE NEED TO LINK TO OR PRESENT SOME KIND OF TABLE WHERE THE BANK IDS ARE LISTED. OR LINK TO &quot;</em>getBankList&quot;
        METHOD. Old documentation also says an &quot;identification&quot;-string
        can be used, which looks like &apos;se-swedbank&apos;. This needs to accommodated
        as well in the new frame to enable backwards-compatibility.</td>
    </tr>
    <tr>
